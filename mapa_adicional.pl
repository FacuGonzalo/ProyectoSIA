...
celda([10,10], resbaladizo).
celda([10,11], resbaladizo).
...
estaEn([p, p12, 2], [12,4]).
estaEn([p, p13, 5], [12,8]).
estaEn([p, p14, 13], [10,3]).
estaEn([p, p15, 8], [13,10]).
estaEn([p, p16, 4], [14,10]).
estaEn([p, p17, 4], [11,10]).
...
sitioDetonacion([2,4]).
sitioDetonacion([10,5]).
sitioDetonacion([9,6]).
sitioDetonacion([5,12]).
sitioDetonacion([8,4]).
